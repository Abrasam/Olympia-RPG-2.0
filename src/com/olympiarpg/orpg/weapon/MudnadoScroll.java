 ...
 */
public class MudnadoScroll extends GenericScroll {
    public MudnadoScroll() {
        super("Mud Tornado Scroll", new String[] {ChatColor.DARK_PURPLE + "" + ChatColor.ITALIC + "Are you sure that's just mud?"}, 1, 1);
    }
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for(double y = 0; y <= 50; y+=0.05) {
                    ...
                    l.setZ(loc.getZ() + z);
                    l.setY(loc.getY() + y);
                    OlympiaRPG.sendParticlePacket(new PacketPlayOutWorldParticles(EnumParticle.BLOCK_DUST,false,(float)l.getX(),(float)l.getY(),(float)l.getZ(),0.5f,0.75f,0.5f, 0, 1, Material.DIRT.getId()));
                }
