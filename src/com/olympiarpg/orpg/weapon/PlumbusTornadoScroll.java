...
public class PlumbusTornadoScroll extends GenericScroll {

    public PlumbusTornadoScroll() {
        super("Regular Tornado Scroll", new String[] {ChatColor.DARK_PURPLE + "" + ChatColor.ITALIC + "Neither hot nor moist, just windy."}, 1, 1);
    }
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for(double y = 0; y <= 50; y+=0.05) {
                    ...
                    l.setZ(loc.getZ() + z);
                    l.setY(loc.getY() + y);
                    OlympiaRPG.sendParticlePacket(new PacketPlayOutWorldParticles(EnumParticle.CLOUD, false, (float)l.getX(), (float)l.getY(), (float)l.getZ(), 0.2f, 0.15f, 0.2f, 0, 1));
                }
