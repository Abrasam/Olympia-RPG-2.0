...
public class ScrollofWaterNado extends GenericScroll {

    public ScrollofWaterNado() {
        super("Waternado Scroll", new String[] {ChatColor.DARK_PURPLE + "" + ChatColor.ITALIC + "Very similar to Sharknado."}, 1, 1);
    }
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for(double y = 0; y <= 50; y+=0.05) {
                    ...
                    l.setZ(loc.getZ() + z);
                    l.setY(loc.getY() + y);
                    OlympiaRPG.sendParticlePacket(new PacketPlayOutWorldParticles(EnumParticle.DRIP_WATER, false, (float)l.getX(), (float)l.getY(), (float)l.getZ(), 0.2f, 0.15f, 0.2f, 0, 1));
                }
