...
public class AbilityAsterblaster extends Ability {

    public AbilityAsterblaster() {
        super("Aster Blaster", 5);
    }
    ...
    public boolean action(Player p) {
        ...
        new MovingParticlesEffect(p.getUniqueId(), EnumParticle.DRAGON_BREATH, l, v, 40, 30, 1) {
            ...
            public void run() {
                ...
                if (flag) {
                    this.cancel();
                    FireworkEffect effect = FireworkEffect.builder().trail(false).flicker(true).withColor(Color.PURPLE).withColor(Color.NAVY).withColor(Color.AQUA).with(FireworkEffect.Type.STAR).build();
